...
class Transaksi_model extends CI_Model {
	...
	{
		return $this->db->insert($this->tableDetailTransaksi, $data);
	}
	...
	{
		$this->db->select('transaksi.id, transaksi.nota, transaksi.tanggal, transaksi.barcode, transaksi.qty, transaksi.total_bayar, transaksi.jumlah_uang, pengguna.nama as kasir');
	...
	{
		$this->db->select("t.id 'idTx', t.tanggal 'tgl', t.total_bayar, t.jumlah_uang, (t.jumlah_uang - t.total_bayar) 'kembali', nota");
