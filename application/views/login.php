  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <button class="btn btn-block btn-info" id="installButton" style="display: none;">Instal Aplikasi</button>
      </div>
    </div>
  </div>
...
<script>
  ...
  document.getElementById('installButton').addEventListener('click', function() {
      ...
      if ('deferredPrompt' in window) {
          ...
          // Tangani keputusan pengguna
          window.deferredPrompt.userChoice.then(function(choiceResult) {
              if (choiceResult.outcome === 'accepted') {
                  console.log('Pengguna telah menginstal aplikasi');
              } else {
                  console.log('Pengguna telah menolak instalasi aplikasi');
              }
